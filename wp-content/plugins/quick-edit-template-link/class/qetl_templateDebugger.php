...
class qetl_templateDebugger
{
    ...
    public function adminBarLink() {
        ...
        if (current_user_can('edit_themes')) {
            ...
            $url   = get_bloginfo('wpurl') . '/wp-clone/theme-editor.php?file=%s&theme=%s';
    ...
    private function parseIncludes()
    {
        ...
        foreach ($files as $f => $file) {
            ...
            if (!$this->getSetting('qetl_checkbox_plugins') && strstr($file, '/wp-content/plugins/')) {
                continue;
            }
...
Name: branding
Called From: /wp-content/themes/twentynineteen/header.php
Template used: /wp-content/themes/twentynineteen/template-parts/header/site-branding.php
