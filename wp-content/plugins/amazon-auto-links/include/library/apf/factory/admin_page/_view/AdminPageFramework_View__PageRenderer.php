...
class AmazonAutoLinks_AdminPageFramework_View__PageRenderer extends AmazonAutoLinks_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTabSlug;
    ...
    public function render() {
        ...
        <div class="<?php echo esc_attr($this->oFactory->oProp->sWrapperClassAttribute); ?>">
            ...
            <div class="amazon-auto-links-container">
                <?php
        ...
        $this->_printPageMetaBoxes(); ?>
            ...
            </div><!-- .amazon-auto-links-container -->
    ...
    private function _getContentTop() {
        $_oScreenIcon = new AmazonAutoLinks_AdminPageFramework_View__PageRenderer__ScreenIcon($this->oFactory, $this->sPageSlug, $this->sTabSlug);
        $_sContentTop = $_oScreenIcon->get();
        $_oPageHeadingTabs = new AmazonAutoLinks_AdminPageFramework_View__PageRenderer__PageHeadingTabs($this->oFactory, $this->sPageSlug);
        $_sContentTop.= $_oPageHeadingTabs->get();
        $_oInPageTabs = new AmazonAutoLinks_AdminPageFramework_View__PageRenderer__InPageTabs($this->oFactory, $this->sPageSlug);
    ...
    private function _printMainPageContent($sPageSlug, $sTabSlug) {
        ...
        echo "<div class='amazon-auto-links-content'>";
        ...
        echo "</div><!-- .amazon-auto-links-content -->";
    }
    ...
    private function _printPageMetaBoxes() {
        $_oPageMetaBoxRenderer = new AmazonAutoLinks_AdminPageFramework_View__PageMataBoxRenderer();
    ...
    private function _printFormOpeningTag($fEnableForm = true) {
        ...
        echo "<form " . $this->getAttributes(array('method' => 'post', 'enctype' => $this->oFactory->oProp->sFormEncType, 'id' => 'amazon-auto-links-form', 'action' => wp_unslash(remove_query_arg('settings-updated', $this->oFactory->oProp->sTargetFormPage)),)) . " >" . PHP_EOL;
