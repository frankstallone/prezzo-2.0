...
class AmazonAutoLinks_AdminPageFramework_View__PageRenderer__PageHeadingTabs extends AmazonAutoLinks_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTag = 'h2';
    ...
    private function _getPageHeadingtabNavigationBar(array $aPages, $sTag, $sCurrentPageSlug) {
        ...
        return $_sTabBar ? "<div class='amazon-auto-links-page-heading-tab'>" . $_sTabBar . "</div>" : '';
    }
