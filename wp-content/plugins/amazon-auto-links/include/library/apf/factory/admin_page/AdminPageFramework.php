...
abstract class AmazonAutoLinks_AdminPageFramework_Router extends AmazonAutoLinks_AdminPageFramework_Factory {
    ...
    public function _replyToLoadComponentsForAjax() {
        ...
        new AmazonAutoLinks_AdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
    ...
    abstract class AmazonAutoLinks_AdminPageFramework_Model_Form extends AmazonAutoLinks_AdminPageFramework_Router {
        public $aFieldErrors;
        ...
        public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'amazon-auto-links') {
            ...
            new AmazonAutoLinks_AdminPageFramework_Model__FormEmailHandler($this);
        ...
        public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            new AmazonAutoLinks_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
        }
    ...
    abstract class AmazonAutoLinks_AdminPageFramework_View_Form extends AmazonAutoLinks_AdminPageFramework_Model_Form {
    ...
    abstract class AmazonAutoLinks_AdminPageFramework_Controller_Form extends AmazonAutoLinks_AdminPageFramework_View_Form {
    ...
    abstract class AmazonAutoLinks_AdminPageFramework_Controller_Menu extends AmazonAutoLinks_AdminPageFramework_View_Menu {
        ...
        public function addSubMenuLink(array $aSubMenuLink) {
            ...
            $_oFormatter = new AmazonAutoLinks_AdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
        ...
        public function addSubMenuPage(array $aSubMenuPage) {
            ...
            $_oFormatter = new AmazonAutoLinks_AdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
    ...
    abstract class AmazonAutoLinks_AdminPageFramework_Controller extends AmazonAutoLinks_AdminPageFramework_View {
        ...
        public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
            ...
            new AmazonAutoLinks_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, 'isInThePage'),));
        }
    ...
    abstract class AmazonAutoLinks_AdminPageFramework extends AmazonAutoLinks_AdminPageFramework_Controller {
        ...
        private function _getCallerPath($sCallerPath) {
            ...
            $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? AmazonAutoLinks_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
