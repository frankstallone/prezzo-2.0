...
class AmazonAutoLinks_AdminPageFramework_View__PageRenderer__InPageTabs extends AmazonAutoLinks_AdminPageFramework_FrameworkUtility {
    ...
    private function _getOutput($aInPageTabs, $sCurrentPageSlug, $sTag) {
        ...
        if (!$_aPage['show_in_page_tabs']) {
            return $this->getElement($aInPageTabs, array($_sCurrentTabSlug, 'title')) ? "<{$_sTag} class='amazon-auto-links-in-page-tab-title'>" . $aInPageTabs[$_sCurrentTabSlug]['title'] . "</{$_sTag}>" : "";
        }
    ...
    private function _getInPageTabNavigationBar(array $aTabs, $sActiveTab, $sCurrentPageSlug, $sTag) {
        ...
        return $_sTabBar ? "<div class='amazon-auto-links-in-page-tab'>" . $_sTabBar . "</div>" : '';
    }
    public function _replyToFormatNavigationTabItem_InPageTab(array $aTab, array $aStructure, array $aTabs, array $aArguments = array()) {
        $_oFormatter = new AmazonAutoLinks_AdminPageFramework_Format_NavigationTab_InPageTab($aTab, $aStructure, $aTabs, $aArguments, $this->oFactory);
