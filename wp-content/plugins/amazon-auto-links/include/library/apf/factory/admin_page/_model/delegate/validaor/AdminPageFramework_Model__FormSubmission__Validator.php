...
class AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator_Base extends AmazonAutoLinks_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator extends AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Link', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Import', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Export', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new AmazonAutoLinks_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
