...
(function ( $ ) {
    ...
    $.fn.updateAmazonAutoLinks_AdminPageFrameworkRepeatableFields = function( aSettings ) {
        ...
        var _oRepeatableButtons = $( nodeThis ).find( '.amazon-auto-links-repeatable-field-buttons' )
            .filter( function() {                                       
                return $( this ).closest( '.amazon-auto-links-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
            });       
...
// @todo event.preventDefault();        
        ...
        var _sFieldID           = _oRepeatableAddButtons.first().closest( '.amazon-auto-links-field' ).attr( 'id' );
        var _nCurrentFieldCount = $( '#' + _sFieldsContainerID ).find( '.amazon-auto-links-field' )
            .filter( function() {                 
                return $( this ).closest( '.amazon-auto-links-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
            })        
            .length;
    ...
    $.fn.addAmazonAutoLinks_AdminPageFrameworkRepeatableField = function( sFieldContainerID ) {
        ...
        if ( ! _aOptions ) {     
            var _nodeButtonContainer = nodeFieldContainer.find( '.amazon-auto-links-repeatable-field-buttons' )
                .filter( function() {                 
                    return $( this ).closest( '.amazon-auto-links-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
                })
                .first();
        ...
        var _oInnerFields       = nodeFieldsContainer.find( '.amazon-auto-links-field' ) 
                                    .filter( function() {                 
                                        return $( this ).closest( '.amazon-auto-links-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
                                    });
        var _oRepeatableButtons = nodeFieldContainer.find( '.amazon-auto-links-repeatable-field-buttons' )
                                    .filter( function() {                 
                                        return $( this ).closest( '.amazon-auto-links-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
                                    }); 
        ...
        var nodeRemoveButtons = nodeFieldsContainer
            ...
            .filter( function() {                      
                return $( this ).closest( '.amazon-auto-links-fields' ).attr( 'id' ) === _sFieldsContainerID;                
            })
