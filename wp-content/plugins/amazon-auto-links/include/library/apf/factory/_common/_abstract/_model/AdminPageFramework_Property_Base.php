...
abstract class AmazonAutoLinks_AdminPageFramework_Property_Base extends AmazonAutoLinks_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'amazon-auto-links' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aAmazonAutoLinks_AdminPageFramework'])) {
            $GLOBALS['aAmazonAutoLinks_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
