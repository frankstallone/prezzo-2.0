...
class AmazonAutoLinks_AdminPageFramework_FieldType_submit extends AmazonAutoLinks_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".amazon-auto-links-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'amazon-auto-links-input-label-container' . ' amazon-auto-links-input-button-container' . ' amazon-auto-links-input-container',);
    }
