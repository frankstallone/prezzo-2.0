...
class AmazonAutoLinks_AdminPageFramework_Form_View___Script_Widget extends AmazonAutoLinks_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.amazon-auto-links-sectionset' ).length <= 0 ) { 
                    return; 
                }   
                ...
                $( document ).trigger( 
                    'amazon-auto-links_saved_widget', 
                    _oWidget 
                );
