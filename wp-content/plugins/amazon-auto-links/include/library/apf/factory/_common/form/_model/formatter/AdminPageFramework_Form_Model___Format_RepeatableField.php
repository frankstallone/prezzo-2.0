...
class AmazonAutoLinks_AdminPageFramework_Form_Model___Format_RepeatableSection extends AmazonAutoLinks_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : AmazonAutoLinks_AdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class AmazonAutoLinks_AdminPageFramework_Form_Model___Format_RepeatableField extends AmazonAutoLinks_AdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
