...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.amazon-auto-links-checkbox-label {margin-top: 0.1em;}.amazon-auto-links-field input[type='checkbox' ] {margin-right: 0.5em;} .amazon-auto-links-field-checkbox .amazon-auto-links-input-label-container {padding-right: 1em;}.amazon-auto-links-field-checkbox .amazon-auto-links-input-label-string{display: inline; }";
    }
    ...
    class AmazonAutoLinks_AdminPageFramework_FieldType_posttype extends AmazonAutoLinks_AdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".amazon-auto-links-field input[type='checkbox'] {margin-right: 0.5em;} .amazon-auto-links-field-posttype .amazon-auto-links-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
