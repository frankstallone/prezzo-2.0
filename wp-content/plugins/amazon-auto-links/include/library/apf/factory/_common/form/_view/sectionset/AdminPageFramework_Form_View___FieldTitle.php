...
class AmazonAutoLinks_AdminPageFramework_Form_View___FieldTitle extends AmazonAutoLinks_AdminPageFramework_Form_Utility {
    ...
    private function _getFieldOutputsInFieldTitleAreaFromNestedFields($aField) {
        ...
        foreach ($aField['content'] as $_aNestedField) {
            ...
            $_oFieldset = new AmazonAutoLinks_AdminPageFramework_Form_View___Fieldset($_aNestedField, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
    ...
    private function _getDebugInfo($aField) {
        ...
        $_oToolTip = new AmazonAutoLinks_AdminPageFramework_Form_View___ToolTip(array('title' => $this->oMsg->get('field_arguments'), 'dash-icon' => 'dashicons-info', 'icon_alt_text' => '[' . $this->oMsg->get('debug') . ' ]', 'content' => AmazonAutoLinks_AdminPageFramework_Debug::getDetails($aField) . '<span class="amazon-auto-links-info">' . $this->getFrameworkNameVersion() . '  (' . $this->oMsg->get('debug_info_will_be_disabled') . ')' . '</span>', 'attributes' => array('container' => array('class' => 'debug-info-field-arguments'),)), $aField['field_id'] . '_debug');
        return $_oToolTip->get();
    }
