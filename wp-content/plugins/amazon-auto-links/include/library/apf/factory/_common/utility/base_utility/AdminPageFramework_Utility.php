...
abstract class AmazonAutoLinks_AdminPageFramework_Utility_Deprecated {
    ...
    static public function getAttributes(array $aAttributes) {
        AmazonAutoLinks_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'AmazonAutoLinks_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    abstract class AmazonAutoLinks_AdminPageFramework_Utility_String extends AmazonAutoLinks_AdminPageFramework_Utility_VariableType {
    ...
    abstract class AmazonAutoLinks_AdminPageFramework_Utility_Path extends AmazonAutoLinks_AdminPageFramework_Utility_ArraySetter {
    ...
    abstract class AmazonAutoLinks_AdminPageFramework_Utility_HTMLAttribute extends AmazonAutoLinks_AdminPageFramework_Utility_SystemInformation {
