...
class AmazonAutoLinks_AdminPageFramework_Form_View___Script_SectionTab extends AmazonAutoLinks_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.amazon-auto-links-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='amazon-auto-links-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
