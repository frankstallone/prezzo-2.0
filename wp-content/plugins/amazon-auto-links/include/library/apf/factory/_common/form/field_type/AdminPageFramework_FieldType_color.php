...
abstract class AmazonAutoLinks_AdminPageFramework_FieldType_Base extends AmazonAutoLinks_AdminPageFramework_Form_Utility {
    ...
    protected function getFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new AmazonAutoLinks_AdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new AmazonAutoLinks_AdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
