...
jQuery( document ).ready( function(){
    ...
    var updateFoundEditors = function( oElements ) {
        ...
        oElements.each( function( iIndex ) {
            ...
            var oSettings = jQuery().getAmazonAutoLinks_AdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );   
    ...
    jQuery().registerAmazonAutoLinks_AdminPageFrameworkCallbacks( {	
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            var _oSettings = jQuery().getAmazonAutoLinks_AdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );  

            // Elements
            var _oField              = oCloned.closest( '.amazon-auto-links-field' );
        ...
        stopped_sorting_fields : function( oSortedFields, sFieldType, sFieldsTagID, iCallType ) { 
            ...
            // Update the editor.
            setTimeout(function(){
                var _oFields = oSortedFields.children( '.amazon-auto-links-field' );
        ...
        stopped_sorting_sections: function( oSections ) {
            ...
            setTimeout(function(){
                var _oFields = jQuery( oSections ).find( '.amazon-auto-links-field' );
                updateFoundEditors( _oFields );           
            }, 100 );
        ...
        saved_widget : function( oWidget ) { 
            ...
            jQuery( oWidget ).find( '.amazon-auto-links-field' ).each( function( iIndex ) {
                ...
                // Store the settings.
                jQuery().storeAmazonAutoLinks_AdminPageFrameworkInputOptions( 
                    oWrap.attr( 'data-id' ), 
                    { 
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".amazon-auto-links-field-textarea .amazon-auto-links-input-label-string {vertical-align: top;margin-top: 2px;} .amazon-auto-links-field-textarea .wp-core-ui.wp-editor-wrap {margin-bottom: 0.5em;}.amazon-auto-links-field-textarea.amazon-auto-links-field .amazon-auto-links-input-label-container {vertical-align: top; float: left;clear: both;} .postbox .amazon-auto-links-field-textarea .amazon-auto-links-input-label-container {width: 100%;}.amazon-auto-links-field-textarea textarea {max-width: 100%;}";
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='amazon-auto-links-textarea-enabler'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
