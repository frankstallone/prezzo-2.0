...
jQuery( document ).ready( function(){
    ...
    jQuery().registerAmazonAutoLinks_AdminPageFrameworkCallbacks( { 
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            setAmazonAutoLinks_AdminPageFrameworkImageUploader( 
 ...
 */
setAmazonAutoLinks_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function() {
        ...
        window.send_to_editor           = hfAmazonAutoLinks_AdminPageFrameworkSendToEditorImage;
...
var hfAmazonAutoLinks_AdminPageFrameworkSendToEditorImage = function( sRawHTML ) {
...
setAmazonAutoLinks_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function( e ) {
        ...
        oAmazonAutoLinks_AdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;
        
        // Assign a custom select object
        wp.media.view.MediaFrame.Select = fExternalSource ? getAmazonAutoLinks_AdminPageFrameworkCustomMediaUploaderSelectObject() : oAmazonAutoLinks_AdminPageFrameworkOriginalImageUploaderSelectObject;
        ...
        _oCustomImageUploader.on( 'close', function() {
            ...
            wp.media.view.MediaFrame.Select = oAmazonAutoLinks_AdminPageFrameworkOriginalImageUploaderSelectObject;
...
removeInputValuesForImage = function( oElem ) {
    ...
    var _oImageInput = jQuery( oElem ).closest( '.amazon-auto-links-field' ).find( '.image-field input' );                  
    if ( _oImageInput.length <= 0 )  {
        return;
    }
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".amazon-auto-links-field .image_preview {border: none; clear: both; margin-top: 0.4em;margin-bottom: 0.8em;display: block; max-width: 100%;height: auto; width: inherit;} .amazon-auto-links-field .image_preview img { display: block;height: auto; max-width: 100%;}.widget .amazon-auto-links-field .image_preview {max-width: 100%;}@media only screen and ( max-width: 1200px ) {.amazon-auto-links-field .image_preview {max-width: 600px;} } @media only screen and ( max-width: 900px ) {.amazon-auto-links-field .image_preview {max-width: 440px;}}@media only screen and ( max-width: 600px ) {.amazon-auto-links-field .image_preview {max-width: 300px;}} @media only screen and ( max-width: 480px ) {.amazon-auto-links-field .image_preview {max-width: 240px;}}@media only screen and ( min-width: 1200px ) {.amazon-auto-links-field .image_preview {max-width: 600px;}}.amazon-auto-links-field-image input {margin-right: 0.5em;vertical-align: middle;}.select_image.button.button-small,.remove_image.button.button-small{ vertical-align: middle;}.remove_image.button.button-small {margin-left: 0.2em;}@media screen and (max-width: 782px) {.amazon-auto-links-field-image input {margin: 0.5em 0.5em 0.5em 0;}}";
    }
...
jQuery( document ).ready( function(){     
    setAmazonAutoLinks_AdminPageFrameworkImageUploader( '{$sInputID}', 'true' === '{$_sRepeatable}', 'true' === '{$_bExternalSource}' );
});
JAVASCRIPTS;
...
JAVASCRIPTS;
        ...
        protected function getStyles() {
            return ".amazon-auto-links-field-media input {margin-right: 0.5em;vertical-align: middle;}@media screen and (max-width: 782px) {.amazon-auto-links-field-media input {margin: 0.5em 0.5em 0.5em 0;}} .select_media.button.button-small,.remove_media.button.button-small{ vertical-align: middle;}.remove_media.button.button-small {margin-left: 0.2em;}";
        }
        protected function _getPreviewContainer($aField, $sImageURL, $aPreviewAtrributes) {
            return "";
        }
...
jQuery( document ).ready( function(){   
    setAmazonAutoLinks_AdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}', 'true' === '{$_sExternalSource}' );
});
JAVASCRIPTS;
