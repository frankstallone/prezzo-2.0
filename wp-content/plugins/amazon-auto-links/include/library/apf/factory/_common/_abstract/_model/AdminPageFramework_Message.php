...
class AmazonAutoLinks_AdminPageFramework_Message {
    ...
    private function ___doDummy() {
        ...
        __('Field Arguments', 'amazon-auto-links');
        ...
        __('Section Arguments', 'amazon-auto-links');
        __('The ability to repeat sections is disabled.', 'amazon-auto-links');
        __('The ability to repeat fields is disabled.', 'amazon-auto-links');
        __('Warning.', 'amazon-auto-links');
    }
    }
