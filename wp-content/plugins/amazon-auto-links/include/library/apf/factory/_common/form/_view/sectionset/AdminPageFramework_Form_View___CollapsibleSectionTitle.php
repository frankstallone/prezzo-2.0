...
class AmazonAutoLinks_AdminPageFramework_Form_View___Section_Base extends AmazonAutoLinks_AdminPageFramework_Form_Base {
    ...
    class AmazonAutoLinks_AdminPageFramework_Form_View___SectionTitle extends AmazonAutoLinks_AdminPageFramework_Form_View___Section_Base {
        ...
        private function _getDebugInfo($aSectionset) {
            ...
            $_oToolTip = new AmazonAutoLinks_AdminPageFramework_Form_View___ToolTip(array('title' => $this->oMsg->get('section_arguments'), 'dash-icon' => 'dashicons-info', 'icon_alt_text' => '[' . $this->oMsg->get('debug') . ' ]', 'content' => AmazonAutoLinks_AdminPageFramework_Debug::getDetails($aSectionset) . '<span class="amazon-auto-links-info">' . $this->getFrameworkNameVersion() . '  (' . $this->oMsg->get('debug_info_will_be_disabled') . ')' . '</span>', 'attributes' => array('container' => array('class' => 'debug-info-field-arguments'),)), $aSectionset['_section_path'] . '_debug');
            return $_oToolTip->get();
        }
        ...
        private function _getFieldsetsInSectionTitleArea(array $aFieldsets, $iSectionIndex, $aFieldTypeDefinitions) {
            ...
            foreach ($aFieldsets as $_aFieldset) {
                ...
                $_oFieldsetOutputFormatter = new AmazonAutoLinks_AdminPageFramework_Form_Model___Format_FieldsetOutput($_aFieldset, $iSectionIndex, $aFieldTypeDefinitions);
