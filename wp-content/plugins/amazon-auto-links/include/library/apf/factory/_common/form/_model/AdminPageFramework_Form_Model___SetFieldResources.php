...
class AmazonAutoLinks_AdminPageFramework_Form_Model___SetFieldResources extends AmazonAutoLinks_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new AmazonAutoLinks_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('AmazonAutoLinks_AdminPageFramework_Form_View___CSS_Form', 'AmazonAutoLinks_AdminPageFramework_Form_View___CSS_Field', 'AmazonAutoLinks_AdminPageFramework_Form_View___CSS_Section', 'AmazonAutoLinks_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'AmazonAutoLinks_AdminPageFramework_Form_View___CSS_FieldError', 'AmazonAutoLinks_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('AmazonAutoLinks_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new AmazonAutoLinks_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new AmazonAutoLinks_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
