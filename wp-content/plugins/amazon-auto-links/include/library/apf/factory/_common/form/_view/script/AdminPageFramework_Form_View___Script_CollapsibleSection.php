...
class AmazonAutoLinks_AdminPageFramework_Form_View___Script_CollapsibleSection extends AmazonAutoLinks_AdminPageFramework_Form_View___Script_Base {
...
( function( $ ) {
    ...
    jQuery( document ).ready( function() {
        jQuery( this ).initializeAmazonAutoLinks_AdminPageFrameworkCollapsibleSections();
    });              
     ...
     * @since    3.7.0
     */
    jQuery( document ).bind( 'amazon-auto-links_saved_widget', function( event, oWidget ){
        jQuery( oWidget ).initializeAmazonAutoLinks_AdminPageFrameworkCollapsibleSections();
    });    
    
    $.fn.initializeAmazonAutoLinks_AdminPageFrameworkCollapsibleSections = function() {
        
        // Expand collapsible sections that are set not to collapse by default 
        jQuery( this ).find( '.amazon-auto-links-collapsible-sections-title[data-is_collapsed=\"0\"]' )
            .next( '.amazon-auto-links-collapsible-sections-content' )
            .slideDown( 'fast' );
        jQuery( this ).find( '.amazon-auto-links-collapsible-section-title[data-is_collapsed=\"0\"]' )
            .closest( '.amazon-auto-links-section-table' )
            .find( 'tbody' )
            .slideDown( 'fast' );
            
        // Hide collapsible sections of 'section' containers as they are somehow do not get collapsed by default.
        jQuery( this ).find( '.amazon-auto-links-collapsible-section-title[data-is_collapsed=\"1\"]' )
            .closest( '.amazon-auto-links-section-table' )
            .find( 'tbody' )
            .hide();
        
        // Bind the click event to the title element.
        jQuery( this ).find( '.amazon-auto-links-collapsible-sections-title, .amazon-auto-links-collapsible-section-title' )
            .enableAmazonAutoLinks_AdminPageFrameworkCollapsibleButton();
        
        // Insert the toggle all button.
        jQuery( this ).find( '.amazon-auto-links-collapsible-title[data-toggle_all_button!=\"0\"]' ).each( function(){
            
            var _oThis        = jQuery( this ); // to access from inside the below each() method.
            var _bForSections = jQuery( this ).hasClass( 'amazon-auto-links-collapsible-sections-title' );   // or for the 'section' container.
            ...
            jQuery.each( _aPositions, function( iIndex, _sPosition ) {
                ...
                var _sLeftOrRight = -1 !== jQuery.inArray( _sPosition, [ 'top-right', 'bottom-right', '0' ] )   // if found
                    ? 'right'   // default
                    : 'left';            
                _oButton.find( '.amazon-auto-links-collapsible-toggle-all-button' ).css( 'float', _sLeftOrRight );
                ...
                if ( _bForSections ) {
                    var _oTargetElement = 'before' === _sTopOrBottom
                        ? _oThis
                        : _oThis.next( '.amazon-auto-links-collapsible-content' );
                        _oTargetElement[ _sTopOrBottom ]( _oButton );
                } else {    // for 'section' containers
                    _oThis.closest( '.amazon-auto-links-section' )[ _sTopOrBottom ]( _oButton );
                }                
                ...
                _oButton.click( function(){                  
                    ...
                    var _oButtons = _bForSections
                        ? jQuery( this ).closest( '.amazon-auto-links-sectionset' ).siblings().andSelf().find( '> .amazon-auto-links-collapsible-toggle-all-button-container' )
                        : jQuery( this ).siblings( '.amazon-auto-links-collapsible-toggle-all-button-container' ).andSelf();
                    _oButtons.toggleClass( 'flipped' );
                    if ( _bForSections ) {
                        _oButton.parent().parent().children().children( '* > .amazon-auto-links-collapsible-title' ).each( function() {
                            jQuery( this ).trigger( 'click', [ 'by_toggle_all_button' ] );
                        } );
                    } else {
                        _oButton.closest( '.amazon-auto-links-sections' ).children( '.amazon-auto-links-section' ).children( '.amazon-auto-links-section-table' ).children( 'caption' ).children( '.amazon-auto-links-collapsible-title' ).each( function() {
                            jQuery( this ).trigger( 'click', [ 'by_toggle_all_button' ] );
                        } );
                    }
     ...
     */
    $.fn.enableAmazonAutoLinks_AdminPageFrameworkCollapsibleButton = function() {
        ...
        function _isFieldElement( nodeTarget ) {
            ...
            if ( jQuery( nodeTarget ).hasClass( 'amazon-auto-links-collapsible-button' ) ) {
                return false;
            }
        ...
        jQuery( this ).click( function( event, sContext ){
            ...
            var _sContainerType = jQuery( this ).hasClass( 'amazon-auto-links-collapsible-sections-title' )
                ? 'sections'
                : 'section';
            var _oTargetContent = 'sections' === _sContainerType
                ? jQuery( this ).next( '.amazon-auto-links-collapsible-content' ).first()
            ...
            if ( 'expand' === _sAction && _oThis.data( 'collapse_others_on_expand' ) ) {
                _oThis.parent().parent().children().children( '* > .amazon-auto-links-collapsible-content' ).not( _oTargetContent ).slideUp( 'fast', function() {
                    jQuery( this ).prev( '.amazon-auto-links-collapsible-title' ).addClass( 'collapsed' );
                });
            }
...
JAVASCRIPTS;
    ...
    static private function _getToggleAllButtonHTML($oMsg) {
        ...
        return "<div class='amazon-auto-links-collapsible-toggle-all-button-container'>" . "<span class='amazon-auto-links-collapsible-toggle-all-button button " . $_sDashIconSort . "'" . " title='" . esc_attr($_sLabelToggleAllSections) . "'>" . $_sText . "</span>" . "</div>";
    }
    }
