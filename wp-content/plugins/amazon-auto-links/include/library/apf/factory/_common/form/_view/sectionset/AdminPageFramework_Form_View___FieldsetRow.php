...
class AmazonAutoLinks_AdminPageFramework_Form_View___FieldsetTableRow extends AmazonAutoLinks_AdminPageFramework_Form_View___Section_Base {
    ...
    protected function _getFieldByContainer(array $aFieldset, array $aOpenCloseTags) {
        ...
        $_oFieldTitle = new AmazonAutoLinks_AdminPageFramework_Form_View___FieldTitle($aFieldset, '', $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        $_aOutput = array();
