...
class AmazonAutoLinks_AdminPageFramework_FieldType_select extends AmazonAutoLinks_AdminPageFramework_FieldType {
    ...
    class AmazonAutoLinks_AdminPageFramework_FieldType_size extends AmazonAutoLinks_AdminPageFramework_FieldType_select {
        ...
        protected function getStyles() {
            return ".amazon-auto-links-field-size input {text-align: right;}.amazon-auto-links-field-size select.size-field-select {vertical-align: 0px; }.amazon-auto-links-field-size label {width: auto; } .form-table td fieldset .amazon-auto-links-field-size label {display: inline-block;}";
        }
        protected function getField($aField) {
        ...
        private function _getNumberInputPart(array $aField, array $aBaseAttributes, $isKey, $bMultiLabels) {
            ...
            $_sLabel = $this->getElementByLabel($aField['label'], $isKey, $aField['label']);
            return "<label " . $this->getAttributes($_aSizeLabelAttributes) . ">" . $this->getElement($aField, $bMultiLabels ? array('before_label', $isKey, 'size') : array('before_label', 'size')) . ($aField['label'] && !$aField['repeatable'] ? "<span " . $this->getLabelContainerAttributes($aField, 'amazon-auto-links-input-label-string') . ">" . $_sLabel . "</span>" : "") . "<input " . $this->getAttributes($_aSizeAttributes) . " />" . $this->getElement($aField, $bMultiLabels ? array('after_input', $isKey, 'size') : array('after_input', 'size')) . "</label>";
        }
