...
class AmazonAutoLinks_AdminPageFramework_Form_View___Sectionsets extends AmazonAutoLinks_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        return $this->_getSpinnerOutput($_sOutput) . "<div id='{$_sElementID}' class='amazon-auto-links-sctionsets amazon-auto-links-form-js-on'>" . $_sOutput . AmazonAutoLinks_AdminPageFramework_Form_View___Script_SectionTab::getEnabler() . $_oDebugInfo->get() . "</div>";
    }
    ...
    private function _getSubSections($_aOutputs, $_sSectionsID, $_aSection, $_aSubSections) {
        if (!empty($_aSection['repeatable'])) {
            $_aOutputs['section_contents'][] = AmazonAutoLinks_AdminPageFramework_Form_View___Script_RepeatableSection::getEnabler($_sSectionsID, $_aOutputs['count_subsections'], $_aSection['repeatable'], $this->oMsg);
            $_aOutputs['section_contents'][] = $this->_getRepeatableSectionFlagTag($_aSection);
        }
        if (!empty($_aSection['sortable'])) {
            $_aOutputs['section_contents'][] = AmazonAutoLinks_AdminPageFramework_Form_View___Script_SortableSection::getEnabler($_sSectionsID, $_aSection['sortable'], $this->oMsg);
