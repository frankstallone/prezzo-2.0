...
class AmazonAutoLinks_AdminPageFramework_Property_page_meta_box extends AmazonAutoLinks_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'amazon-auto-links', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['aAmazonAutoLinks_AdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aAmazonAutoLinks_AdminPageFramework', 'aMetaBoxForPagesClasses'));
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aAmazonAutoLinks_AdminPageFramework', 'aPageClasses'));
