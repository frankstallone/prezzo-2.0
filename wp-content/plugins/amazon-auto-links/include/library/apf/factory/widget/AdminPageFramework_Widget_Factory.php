...
class AmazonAutoLinks_AdminPageFramework_Widget_Factory extends WP_Widget {
    ...
    public function form($aSavedFormData) {
        ...
        $this->oCaller->oForm = new AmazonAutoLinks_AdminPageFramework_Form_widget(array('register_if_action_already_done' => false,) + $this->oCaller->oProp->aFormArguments, $this->oCaller->oForm->aCallbacks, $this->oCaller->oMsg);
