...
(function($){$(document).ready(function(){$('.row-actions .copy a').click(function(){copyToClipboard(document.getElementById($(this).attr('data-target')));alert('Copied the text.')})
