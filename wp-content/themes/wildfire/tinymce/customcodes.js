    ...
    tinymce.create('tinymce.plugins.button_progression', {  
        init : function(ed, url) {  
            ed.addButton('button_progression', {  
                ...
                image : url+'/button-button.png',  
                onclick : function() {  
                     ed.selection.setContent('[button_progression link="" target="" size="progression-small or progression-medium or progression-large" color="progression-red"]Text here[/button_progression]');  
