...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'progression'),
		'repeat-x'  => __('Repeat Horizontally', 'progression'),
		'repeat-y'  => __('Repeat Vertically', 'progression'),
		'repeat'    => __('Repeat All', 'progression'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'progression'),
		'top center'    => __('Top Center', 'progression'),
		'top right'     => __('Top Right', 'progression'),
		'center left'   => __('Middle Left', 'progression'),
		'center center' => __('Middle Center', 'progression'),
		'center right'  => __('Middle Right', 'progression'),
		'bottom left'   => __('Bottom Left', 'progression'),
		'bottom center' => __('Bottom Center', 'progression'),
		'bottom right'  => __('Bottom Right', 'progression')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'progression'),
		'fixed'  => __('Fixed in Place', 'progression')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'progression'),
		'italic'      => __('Italic', 'progression'),
		'bold'        => __('Bold', 'progression'),
		'bold italic' => __('Bold Italic', 'progression')
		);
