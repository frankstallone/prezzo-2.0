...
function progression_posted_on() {
	printf( __( '<div class="post-date"><a href="%1$s"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a></div><div class="post-author"><a class="url fn n" href="%5$s" title="%6$s" rel="author">by %7$s</a></div>', 'progression' ),
